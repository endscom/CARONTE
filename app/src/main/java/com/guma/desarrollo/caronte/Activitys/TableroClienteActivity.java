...
public class TableroClienteActivity extends AppCompatActivity {
    ...
    private void infoCliente(String CodCliente){
        ...
        if(cursor.length > 0)
        {
            items.add(new Indicadores3(R.drawable.logo, "VENTA EN VALORES", "Promedio: ".concat(cursor[0]==null?"0.00":cursor[0]), "Meta: ".concat(cursor[10]==null?"0.00":cursor[10]), "Actual: ".concat(cursor[4]==null?"0.00":cursor[4]), "Pendiente: 0"  ));
            items.add(new Indicadores3(R.drawable.logo, "PROMEDIO DE ITEMS FACTURADOS", "Promedio: ".concat(cursor[1]==null?"0":cursor[1]), "Meta: ".concat(cursor[13]==null?"0.00":cursor[13]), "Actual: ".concat(cursor[5]==null?"0":cursor[5]), "Pendiente: 0"));
            items.add(new Indicadores3(R.drawable.logo, "MONTO POR FACTURA", "Promedio: ".concat(cursor[3]==null?"0":cursor[3]), "Meta: ".concat(cursor[12]==null?"0.00":cursor[12]), "Actual: ".concat(cursor[7]==null?"0":cursor[7]), "Pendiente: 0"));
            ...
            items.add(new Indicadores3(R.drawable.logo, "PRODUCTOS FACTURADOS", "Promedio: ".concat(cursor[8]==null?"0":cursor[8]), "Meta: ".concat(cursor[11]==null?"0.00":cursor[11]), "Actual: ".concat(cursor[9]==null?"0":cursor[9]), "Pendiente: 0"));
        }
